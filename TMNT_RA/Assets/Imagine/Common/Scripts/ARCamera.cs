...
namespace Imagine.WebAR
{
    ...
    public class ARCamera : MonoBehaviour
    {
        ...
        [SerializeField, Tooltip("Mirror the camera image horizontally without affecting AR tracking.")]
        private bool mirrorHorizontally = false;

        [HideInInspector] public bool isFlipped = false;
        private bool rawIsFlipped = false;
        ...
        private IEnumerator Start()
        {
            rawIsFlipped = false;
#if UNITY_WEBGL && !UNITY_EDITOR
            rawIsFlipped = WebGLIsCameraFlipped();
#endif
            ApplyFlipState();
        ...
        public void Resize(string dims)
        {
            ...
            // Ensure the plane uses the current flip state
            UpdateVideoPlaneFlip();
        ...
        public void SetMirrorHorizontally(bool value)
        {
        ...
        private void OnValidate()
        {
            ...
            {
                isFlipped = mirrorHorizontally ? !rawIsFlipped : rawIsFlipped;
            }
            else
            {
                ApplyFlipState();
        ...
        private void ApplyFlipState()
        {
            bool newIsFlipped = mirrorHorizontally ? !rawIsFlipped : rawIsFlipped;
        ...
        private void UpdateVideoPlaneFlip()
        {
            if (videoBackground == null)
            {
                return;
